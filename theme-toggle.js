(function () {
    ...
    const romanian = (root.lang || '').toLowerCase().startsWith('ro');
    const labels = romanian
        ? { light: 'Temă luminoasă', dark: 'Temă întunecată' }
    ...
    function apply(theme) {
        ...
        if (meta) meta.content = dark ? '#111827' : '#faf8f4';
    }
